...
const product = {"repo":"PortGuard","suite":"Cybersecurity Suite","category":"Network exposure","audience":"security analysts, IT admins, and MSP operators","promise":"see risky open ports before attackers turn them into doors","inputLabel":"Target host, subnet, or asset group","placeholder":"api.company.com, 10.10.12.0/24, or finance laptops","primary":"Scan exposure","gradient":"from-emerald-300 via-cyan-300 to-blue-400","metrics":["42 sec triage","18 controls","7 risk lenses"],"modules":["Attack surface score","Port-to-service fingerprint","Misconfiguration checklist","Remediation runbook","Executive exposure brief"],"outputs":["Public service risk score","Most dangerous port/service pair","Suggested firewall rule","Owner and SLA recommendation"],"pricing":"Free single target scan, $29/month Analyst, $149/month Team, custom MSP workspace."} as const;
