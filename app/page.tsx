      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
          ...
          <div className="hidden items-center gap-6 text-sm text-white/65 md:flex">
            <a href="#product">Product</a><a href="#workflow">Workflow</a><a href="#pricing">Pricing</a><a href="#try" className="rounded-full bg-white px-4 py-2 font-bold text-black">Try live</a>
          </div>
        </nav>
        <div className="relative z-10 mx-auto grid max-w-7xl gap-10 px-5 pb-16 pt-10 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:pb-24 lg:pt-16">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row"><a href="#try" className="rounded-full bg-white px-6 py-4 text-center text-sm font-black text-black shadow-2xl shadow-white/10">{product.primary}</a><a href="#workflow" className="rounded-full border border-white/15 px-6 py-4 text-center text-sm font-bold text-white/80">See workflow</a></div>
